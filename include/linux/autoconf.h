...
#define CONFIG_MACH_SEMC_SATSUMA 1
...
#define CONFIG_FB_MSM_MDDI_SII_HVGA_LCD 1
...
#define CONFIG_MD 1
#define CONFIG_LOCALVERSION "$(KERNEL_LOCAL_VERSION)-Kappa"
